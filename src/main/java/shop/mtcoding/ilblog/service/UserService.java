...
import shop.mtcoding.ilblog.dto.user.UserReq.JoinReqDto;
import shop.mtcoding.ilblog.dto.user.UserReq.LoginReqDto;
import shop.mtcoding.ilblog.handler.ex.CustomException;
import shop.mtcoding.ilblog.model.User;
import shop.mtcoding.ilblog.model.UserRepository;
...
public class UserService {
    ...
    public void 회원가입(JoinReqDto joinReqDto) {
        User sameUser = userRepository.findByUser(joinReqDto.getUsername());
        if (sameUser != null) {
